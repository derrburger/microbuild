  ...
  useEffect(() => {
    ...
    supabase
      ...
      .then(({ data: up }) => {
        ...
        // If creator, also fetch creator_profiles
      ...
      <div className="container dashboard-body">
        ...
        {userProfile.account_type === 'creator' && (
          creatorProfile
            ...
            : (
              <div className="dash-pending-profile">
                <div className="dash-pending-icon">⏳</div>
                <h2>Profile Pending Setup</h2>
                <p>
                  Your creator account has been created. The MicroBuild team will
                  link your profile after reviewing your application.
                  Check back here once you receive an approval notification.
                </p>
                <div className="dash-pending-actions">
                  <Link to="/creators/apply" className="btn btn-primary btn-sm">
                    Submit / Check Application →
                  </Link>
                  <Link to="/browse" className="btn btn-ghost btn-sm">Browse Builds</Link>
                </div>
              </div>
